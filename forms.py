...
class NewTripForm(Form):
	...
	start_date = DateField("start_date", validators=[validators.Required()])
	end_date = DateField("end_date", validators=[validators.Required()])
	activity = SelectField("activity", coerce=int, validators=[validators.Required()])
